...
#include "../platformer/helper_code/Loader.h"
#include <stdexcept>
...
void Engine::Start(unsigned int width, unsigned int height,
	...
	while (window.isOpen()) {
		...
		if (!Keyboard::isKeyPressed(Controls::GetKey("Return"))) {
			_activeScene->flag_escPressed = false;
		}

		if (Keyboard::isKeyPressed(Controls::GetKey("Return")) && !_activeScene->flag_escPressed) {
			if (Engine::GetActiveScene()->pause == true) {
				Engine::GetActiveScene()->pause = false;
			}
			else {
				Engine::GetActiveScene()->pause = true;
			}

			_activeScene->flag_escPressed = true;
		}
